...
plot(unique_rt, cum_prob, type = "l", main = "Empirical Distribution Function (EDF) of Portfolio Returns",xlab = "Returns", ylab = "EDF")
...
# Density plot with 5% quantile line
plot(density(rt_ptfR3[, 1]), main = "Kernel Density of Low Risk Portfolio Returns", 
     xlab = "Returns", ylab = "Density")
abline(v = quantile(rt_ptfR3, probs = 0.05), col = "red", lty = "dashed", lwd = 2)
legend("topright", legend = c("Density", "5% Quantile"), 
       col = c("black", "red"), lty = c("solid", "dashed"), lwd = c(1, 2), cex = 0.8)
